...
<html>
	<head>
		<title> Explore | Food Resto Pin </title>
	</head>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<center>
						<img src="images/1.png" style="width:62.5%;">
					</center>
					<div class="carousel-caption"></div>
				</div>
				<!--div class="item"><img src="images/home.jpg" style="width:100%;"><div class="carousel-caption"></div></div-->
				<div class="item">
					<img src="images/2.jpg" style="width:71.5%;">
					<div class="carousel-caption"></div>
				</div>
				<div class="item">
					<img src="images/3.jpg" style="width:75.4%; float:right;">
					<div class="carousel-caption"></div>
				</div>
			</div>
            ...
            <div class="col-md-3">
				<form method="post" action="cart.php?action=add&id=
					...
					<div class="mypanel" align="center" ;>
						<img src="
													<?php echo $row["images_path"]; ?>" class="img-responsive" style="width:320px; height: 250px;">
			...
			<div class="jumbotron">
				<center>
					<label style="margin-left: 5px;color: red;">
						<h1>There are no available food right now.</h1>
					</label>
				</center>
			</div>
		</div> 
