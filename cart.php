...
if(empty($_SESSION["cart"]))
{
  ?> <div class="container">
			<div class="jumbotron">
				<h1> Your Cart </h1>
				<p> Looks like your cart is empty. Go back and <a href="foodlist.php">order now.</a>
				</p>
			</div>
		</div>
		<br>
...
{
echo '<script>alert("The food item is already in your cart")</script>';
echo '<script>window.location="cart.php"</script>';
}
}
else
...
echo '
																									<script>alert("Removed food item")</script>';
echo '
...
unset($_SESSION["cart"]);
echo '
																									<script>alert("Your cart is now empty")</script>';
echo '
																									<script>window.location="cart.php"</script>';
