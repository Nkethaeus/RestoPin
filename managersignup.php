<html>
	<head>
		<title> Manager Signup | Resto Pin </title>
	</head>
	...
	<body>
		...
		<div class="container">
			<div class="jumbotron">
				<h1>Hello Manager, <br> Welcome to <span class="edit"> Resto Pin </span>
				</h1>
				<br>
			</div>
		</div>
						...
						<form role="form" action="manager_registered_success.php" method="POST">
							<div class="row">
								<div class="form-group col-xs-12">
									<label for="fullname">
										<span class="text-danger" style="margin-right: 5px;">*</span> Full Name: </label>
							...
							<div class="row">
								<div class="form-group col-xs-12">
									<label for="email">
										<span class="text-danger" style="margin-right: 5px;">*</span> Email: </label>
									<div class="input-group">
							...
							<div class="row">
								<div class="form-group col-xs-12">
									<label for="contact">
										<span class="text-danger" style="margin-right: 5px;">*</span> Contact: </label>
									<div class="input-group">
							...
							<div class="row">
								<div class="form-group col-xs-12">
									<label for="address">
										<span class="text-danger" style="margin-right: 5px;">*</span> Address: </label>
									<div class="input-group">
							...
							<label style="margin-left: 5px;">Already have a manager account?</label>
							<label style="margin-left: 5px;">
								<a href="managerlogin.php">Login now!</a>
							</label>
						</form>
					</div>
				</div>
	...
	<footer class="container-fluid bg-4 text-center">
		<br>
		<p> Resto Pin 2021 | &copy All Rights Reserved </p>
		<br>
	</footer>
</html>